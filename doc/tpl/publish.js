...
function addAttribs(f) {
  ...
  f.attribs =
    '<span class="type-signature">' + htmlsafe(attribs.length ? "<" + attribs.join(", ") + "> " : "") + "</span>";
}
...
function searchData(html) {
  ...
  let stripped = sanitizeHtml(html, { allowedTags: [], allowedAttributes: [] });
...
exports.publish = function (taffyData, opts, tutorials) {
  ...
  function generateQuickTextSearch(templatePath, searchableDocuments, navOptions) {
    ...
    const tmplString = fs.readFileSync(templatePath + "/quicksearch.tmpl").toString(),
