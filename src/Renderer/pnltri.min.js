...
r.c = {
    ...
    da: function(b) {
        for (var c = b.length - 1; 0 < c; c--) {
            var l = Math.floor(r.c.random() * (c + 1)),
                k = b[c];
            b[c] = b[l];
            b[l] = k;
        }
...
function u(b) {
    ...
    if (b)
        for (var c = 0, l = b.length; c < l; c++) {
            var k = w(this, b[c]);
            if (3 > k.length) console.log("Polygon has < 3 vertices!", k);
            else {
                for (
...
function w(b, c) {
    ...
    function k(a, b, c) {
        ...
        Math.abs(a.y - b.y) < r.c.n
            ? ((d = b.x),
              a.x < c.x ? ((b = a.x), (a = c.x)) : ((b = c.x), (a = a.x)))
            : ((d = b.y),
    ...
    for (var a = [], e, d, f, h = 0; h < c.length; h++)
        (e = D(b, c[h].x, c[h].y)),
            ...
            0 <= f &&
                (l(e, a[f])
                    ? (d = !1)
                    : 0 < f && k(a[f - 1], a[f], e) && a.pop()),
            d && a.push(e);
    f = a.length - 1;
    0 < f && l(a[f], a[0]) && (a.pop(), f--);
    1 < f &&
        (k(a[f - 1], a[f], a[0]) && (a.pop(), f--),
        1 < f && k(a[f], a[0], a[1]) && a.shift());
    return a;
}
function x(b, c, l) {
    return {
...
H.prototype = {};
function I(b) {
    var c = new F(null, null, null, null);
    this.B = [];
    J(this, c);
    this.root = new H(c);
    if (b)
...
I.prototype = {
    P: function(b) {
        ...
        for (l = this.B.length; c < l; c++) {
            var d = this.B[c],
                f = d.e ? (d.f ? 5 : 7) : d.f ? 4 : 6,
                h = d.b ? (d.d ? 1 : 0) : d.d ? 3 : 2;
            if (1 == d.depth % 2) {
                if (
                    5 == f ||
                    1 == h ||
                ...
                null !== d.q.id && (e[d.q.id] = f),
                    null !== d.l.id && (e[d.l.id] = h);
        }
        var t;
        for (c = 0; c < k; c++)
            if (((d = a[c]), (f = e[c]), null != f)) {
                l = f;
                h = null;
                do
                    if ((7 < l++ && (l = 0), (b = d[l])))
                        h ? ((b.j = h), (h.g = b)) : ((t = b.a), (t.Y = b)),
                            (h = b.aa);
                while (l != f);
                h && (t.Z = h);
            }
...
function L(b, c) {
    ...
    if (g.e || g.f)
        if (g.q != h)
            console.log("ERR add_segment: trFirstHigh != segHigh: ", g);
        else {
            f || (d = O(b, d, e, !0));
            var t = d.A,
                m = g,
...
function Q(b, c) {
    ...
    for (var e; a; )
        if (a.V) a = -1 == r.c.G(l == a.V ? k : l, a.V) ? a.left : a.right;
        else if (a.h) {
            if (l == a.h.a || l == a.h.i)
                ...
                (e = M(a.h, l)),
                    0 === e &&
                        ((e = M(a.h, k)),
                        0 === e && (e = M(a.h, c ? b.o.a : b.m.i)));
            if (0 < e) a = a.left;
            else if (0 > e) a = a.right;
            else break;
        } else {
        ...
        if (!k) {
            ...
            if (1 != f)
                for (h = Array(f), g = a.concat(), p = 0; p < g.length; p++)
                    (t = g[p].O),
                        h[t] ? (a[f++] = g[p]) : ((a[d++] = g[p]), (h[t] = !0));
            d = a.length;
            f = e.$;
            h = 0;
            for (g = d; h < d; ) {
                g = Math.log(g) / Math.LN2;
                for (p = 1 < g ? Math.floor(d / g) : d; h < p; h++) L(f, a[h]);
                for (p = h; p < d; p++) N(a[p]);
            }
            var e = e.k,
                f = [f.B[0]],
            ...
            do {
                for (t = 1 == p % 2; (g = f.pop()); )
                    -1 == g.depth &&
                        ...
                        g.b && f.push(g.b),
                        g.d && f.push(g.d),
                        (s = g.t) && -1 == s.J.depth && h.push(s.J),
                        (s = g.s)) &&
                        (-1 == s.K.depth && h.push(s.K),
                        s.p != t && (e.F[s.O] = !1));
                f = h;
                h = [];
                p++;
