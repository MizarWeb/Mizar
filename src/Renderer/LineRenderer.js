...
LineRenderer.prototype.render = function (renderables, start, end) {
  ...
  for (var n = start; n < end; n++) {
    ...
    gl.uniform1f(
      ...
      style.hasOwnProperty("gradientLength") ? style.gradientLength : 10.0
    );
...
LineRenderer.prototype.canApply = function (type, style) {
  return (
    (type === Constants.GEOMETRY.LineString || type === Constants.GEOMETRY.MultiLineString) && style.gradientLength
  );
};
