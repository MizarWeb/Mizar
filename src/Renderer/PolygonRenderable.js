...
import Triangulator from "../Tiling/Triangulator";
import PolygonCutter from "./PolygonCutter";
...
PolygonRenderer.prototype.canApply = function (type, style) {
  return style.fill && (type === Constants.GEOMETRY.Polygon || type === Constants.GEOMETRY.MultiPolygon);
};
...
export default PolygonRenderable;
