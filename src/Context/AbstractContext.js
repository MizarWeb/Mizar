...
import GlobeFactory from "../Globe/GlobeFactory";
...
import WMSServerRegistryHandler from "../Registry/WMSServerRegistryHandler";
import WMTSServerRegistryHandler from "../Registry/WMTSServerRegistryHandler";
import WCSServerRegistryHandler from "../Registry/WCSServerRegistryHandler";
import OpenSearchRegistryHandler from "../Registry/OpenSearchRegistryHandler";
import PendingLayersRegistryHandler from "../Registry/PendingLayersRegistryHandler";
import LayerRegistryHandler from "../Registry/LayerRegistryHandler";
import Compass from "../Gui/Compass";
import PositionTracker from "../Gui/Tracker/PositionTracker";
import ElevationTracker from "../Gui/Tracker/ElevationTracker";
import TimeTravel from "../Gui/TimeTravel";
import AttributionHandler from "../Utils/AttributionHandler";
import ErrorDialog from "../Gui/dialog/ErrorDialog";
import "../Renderer/PointRenderer";
import "../Renderer/LineStringRenderable";
import "../Renderer/PolygonRenderer";
import "../Renderer/LineRenderer";
import "../Renderer/PointSpriteRenderer";
import "../Renderer/ConvexPolygonRenderer";
import "../Renderer/PolyLineRenderer";
...
function _createTrackerPosition(mizarConfiguration) {
  try {
    return new PositionTracker({
      element:
        mizarConfiguration.positionTracker && mizarConfiguration.positionTracker.element
          ? mizarConfiguration.positionTracker.element
          : DEFAULT_POSITION_TRACKER_ELT,
      isMobile: mizarConfiguration.isMobile,
      position:
        mizarConfiguration.positionTracker && mizarConfiguration.positionTracker.position
...
function _createTrackerElevation(mizarConfiguration, ctxOptions) {
  try {
    return new ElevationTracker({
      element:
        mizarConfiguration.elevationTracker && mizarConfiguration.elevationTracker.element
          ? mizarConfiguration.elevationTracker.element
          : DEFAULT_ELEVATION_TRACKER_ELT,
      isMobile: mizarConfiguration.isMobile,
      position:
        mizarConfiguration.elevationTracker && mizarConfiguration.elevationTracker.elevation
...
AbstractContext.prototype.getLayerByName = function (layerName) {
  return _.findWhere(this.getLayers(), {
    name: layerName
  });
};
...
AbstractContext.prototype.initGlobe = function (globeOptions, navigationMode) {
  try {
    ...
    this.navigation = NavigationFactory.create(
      navigationType,
      this,
      this.ctxOptions.navigation ? this.ctxOptions.navigation : this.ctxOptions
    );
    this.attributionHandler = new AttributionHandler(this.globe, {
      element:
        this.mizarConfiguration.attributionHandler && this.mizarConfiguration.attributionHandler.element
