...
import CompassCore from "../Services/CompassCore";
...
function _handleMouseMove(event, self) {
  ...
  var _outerCircleRadius = self.outerCircle.ownerSVGElement.clientWidth / 2;
  var c =
    self._lastMouseX * (event.layerY - _outerCircleRadius) - self._lastMouseY * (event.layerX - _outerCircleRadius); // c>0 -> clockwise, counterclockwise otherwise
