...
define(["jquery", "./AbstractProvider", "../Renderer/FeatureStyle", "../Utils/Utils", "../Utils/Constants", "../Services/MeasureToolPlanetCore"],
    function ($, AbstractProvider, FeatureStyle, Utils, Constants, MeasureToolPlanetCore) {
