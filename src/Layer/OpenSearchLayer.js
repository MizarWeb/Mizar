...
define([
    ...
    OpenSearchLayer.prototype._addFeatureToRenderers = function(feature) {
        ...
        if (geometry.type === "GeometryCollection") {
            ...
            for (var i = 0; i < geoms.length; i++) {
                this.getGlobe().vectorRendererManager.addGeometry(
                    this,
                    geoms[i],
                    style
                );
    ...
    OpenSearchLayer.prototype._addFeatureToRenderersCurrentLevel = function(
        ...
        if (geometry.type === "GeometryCollection") {
            var geoms = geometry.geometries;
            for (var i = 0; i < geoms.length; i++) {
                this.getGlobe().vectorRendererManager.addGeometryCurrentLevel(
                    this,
                    geoms[i],
                    style
                );
    ...
    OpenSearchLayer.prototype._removeFeatureFromRenderersCurrentLevel = function(
        ...
        return this.globe.vectorRendererManager.removeGeometryCurrentLevel(
            feature.geometry,
            this
        );
    };
    ...
    OpenSearchLayer.prototype._removeFeatureFromRenderers = function(feature) {
        return this.globe.vectorRendererManager.removeGeometry(
            feature.geometry,
            this
        );
    };
    ...
    OpenSearchLayer.prototype.removeFeature = function(featureId) {
        ...
        this.getGlobe().vectorRendererManager.removeGeometry(
            feature.geometry,
            this
        );
