  ...
  if (mandatory === "R" && !hipsMetadata.hasOwnProperty(key)) {
    ...
    if (key === "creator_did" && hipsMetadata.hips_version === "1.2") {
      ...
      ErrorDialog.open(
        ...
        "Deprecated Hips version <b>1.2</b> for " + hipsMetadata.obs_title,
    ...
    //Fix for version=1.3
      ...
      ErrorDialog.open(
        Constants.LEVEL.WARNING,
        "Deprecated Hips version <b>1.3</b> for " + hipsMetadata.obs_title,
        "please update it - <i>use creator_did=publisher_did</i>"
      );
    ...
    //Fox for version 1.4
      ...
      ErrorDialog.open(
        Constants.LEVEL.WARNING,
        "creator_did not found in v1.4 for " + hipsMetadata.obs_title,
    ...
    /// very old version
      ...
      ErrorDialog.open(
        Constants.LEVEL.WARNING,
        "Deprecated Hips version <b>unknown</b> for " + hipsMetadata.obs_title,
