...
import GroundOverlayRenderer from "../Renderer/GroundOverlayRenderer";
...
GroundOverlayLayer.prototype.computeInverse = function () {
  var det =
    this.transform[0] * (this.transform[8] * this.transform[4] - this.transform[5] * this.transform[7]) -
...
export default GroundOverlayLayer;
