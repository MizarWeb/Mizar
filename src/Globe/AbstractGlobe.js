...
AbstractGlobe.prototype.getLonLatFromPixel = function (x, y) {
  ...
  if (
    ...
    this.cachedPickingValue.x === x &&
    this.cachedPickingValue.y === y
  ) {
...
AbstractGlobe.prototype.setCoordinateSystem = function (coordinateSystem) {
  ...
  if (
    (this.coordinateSystem.isFlat() &&
      this.coordinateSystem.getProjection().getName() === Constants.PROJECTION.Azimuth) ||
